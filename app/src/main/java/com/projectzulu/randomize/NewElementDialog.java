...
public class NewElementDialog extends DialogFragment {
    ...
    public interface NewElementDialogListener {
        public void onDialogPositiveClick(String name);
    }

    private NewElementDialogListener mListener;

    public void setListener(NewElementDialogListener listener) {
        mListener = listener;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(R.string.dialog_element_name_title)
                .setView(getActivity().getLayoutInflater().inflate(R.layout.dialog_new_element, null))
                ...
                .setPositiveButton(R.string.dialog_create, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        EditText editText = (EditText) ((AlertDialog) dialog)
                                .findViewById(R.id.new_element_name);
    ...
    public void onStart() {
        ...
        final EditText editText = (EditText) dialog.findViewById(R.id.new_element_name);
